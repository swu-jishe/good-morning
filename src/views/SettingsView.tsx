          ...
          >
            <header className="mb-8 shrink-0">
              ...
              <p className="text-slate-500 mt-2 text-sm leading-relaxed max-w-2xl">
                配置并管理 Goal Radar 的底层信息抓取节点。你可以接入任意网页、RSS 或平台，系统将自动汇总原始信息，并交由 Agent 提炼至工作台。
              </p>
            </header>
              ...
              <section>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-5">
                  {sources.map((source) => (
                    ...
                    >
                      <div className="flex justify-between items-start mb-4">
                        ...
                        <div className="flex items-center gap-2">
                          <span className="flex items-center gap-1.5 text-[11px] font-medium text-slate-500 bg-slate-50 px-2 py-1 rounded-lg">
                      ...
                      <div className="mb-4">
                        <h3 className="font-bold text-slate-900 text-[15px] mb-1 line-clamp-1" title={source.name}>
                          {source.name}
                        </h3>
                      ...
                      <div className="bg-slate-50 border border-slate-100 rounded-2xl p-3.5 mb-4 group-hover:border-indigo-100 transition-colors flex-1 cursor-pointer" onClick={() => setSelectedSourceId(source.id)}>
                        <div className="text-[11px] font-semibold text-slate-400 mb-1.5 flex items-center justify-between">
                          <span>最新抓取动态</span>
                          <span className="text-indigo-500 bg-indigo-50 px-1.5 py-0.5 rounded text-[9px]">RAW</span>
                        </div>
                  ...
                  >
                    ...
                    <h3 className="font-bold text-[15px] mb-1">新增信息源</h3>
                  ...
                  {selectedSource.items.map((item, idx) => (
                    ...
                    >
                      <div className="flex flex-col mb-2 sm:mb-0">
                        <h4 className="font-bold text-slate-800 text-[15px] group-hover:text-indigo-700 transition-colors flex items-center gap-2">
                          {item.title}
                      ...
                      <div className="sm:ml-4 shrink-0 flex items-center gap-2">
                        {idx === 0 && <span className="text-[10px] bg-red-50 text-red-600 font-bold px-2 py-0.5 rounded-md border border-red-100">New</span>}
